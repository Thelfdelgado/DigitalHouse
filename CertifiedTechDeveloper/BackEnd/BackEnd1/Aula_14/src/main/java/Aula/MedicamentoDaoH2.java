...
public class MedicamentoDaoH2 implements IDao<Medicamento> {
    ...
    public Medicamento salvar(Medicamento medicamento) {
        ...
        Statement s = null;
        String query = String.format("INSERT INTO medicamentos(id,nome,laboratorio, quantidade, preco) VALUES ('%s','%s','%s','%s','%s')",
                medicamento.getId(),medicamento.getNome(),medicamento.getLaboratorio(),medicamento.getQuantidade(),medicamento.getPreco());
        ...
        try {
            ...
            log.error("Medicamento nao registrado");
            e.printStackTrace();
        }
        return medicamento;
    }
